export default {
  ...
  'menu.flow':'流程',
  'menu.flow.stepform': '发起流程',
  'menu.flow.stepform.info': '分步表单--填写申请表',
  'menu.flow.stepform.confirm': '分步表单--选择受理人',
  'menu.flow.stepform.result': '分步表单--完成',
  'menu.flow.monitor1':'流程监控',
  'menu.flow.list1':'流程查询',
  'menu.flow.manage':'流程管理',
